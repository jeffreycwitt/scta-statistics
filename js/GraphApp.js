...
var graphs = new Backbone.Collection([
	...
	{id: 3, title: "Frequency of Mentions of Classical Authors", description: "A Graph that shows the frequency of mentions of Classical authors in medieval Sentences commentaries", query: 'select ?ref ?reftitle  (count(?element) as ?count) where { ?element a <http://scta.info/resource/nameElement> . ?element <http://scta.info/property/isInstanceOf> ?ref . ?ref <http://purl.org/dc/elements/1.1/title> ?reftitle . ?ref <http://scta.info/property/personType> <http://scta.info/resource/persontype/Classical> .} group by ?ref ?reftitle'},
	{id: 4, title: "Frequency of Mentions of Patristic Authors", description: "A Graph that shows the frequency of mentions of Patristic authors in medieval Sentences commentaries", query: 'select ?ref ?reftitle  (count(?element) as ?count) where { ?element a <http://scta.info/resource/nameElement> . ?element <http://scta.info/property/isInstanceOf> ?ref . ?ref <http://purl.org/dc/elements/1.1/title> ?reftitle . ?ref <http://scta.info/property/personType> <http://scta.info/resource/persontype/Patristic> .} group by ?ref ?reftitle'},
	{id: 5, title: "Frequency of Mentions of Any Author", description: "A Graph that shows the frequency of mentions of any author in medieval Sentences commentaries", query: "select ?ref ?reftitle  (count(?element) as ?count) where { ?element a <http://scta.info/resource/nameElement> . ?element <http://scta.info/property/isInstanceOf> ?ref . ?ref <http://purl.org/dc/elements/1.1/title> ?reftitle . } group by ?ref ?reftitle"},
