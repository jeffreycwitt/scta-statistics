...
var graphs = new Backbone.Collection([
	{id: 1, title: "Frequency of Mentions of Scholastic Names", description: "A Graph that shows the frequency of mentions of Scholastic authors in medieval Sentences commentaries", query: 'select ?ref ?reftitle  (count(?element) as ?count) where { ?element a <http://scta.info/resource/nameElement> . ?element <http://scta.info/property/isInstanceOf> ?ref . ?ref <http://purl.org/dc/elements/1.1/title> ?reftitle . ?ref <http://scta.info/property/personType> <http://scta.info/resource/persontype/Scholastic> .} group by ?ref ?reftitle'},
	{id: 2, title: "Frequency of Mentions of Biblical Names", description: "A Graph that shows the frequency of mentions of Biblical authors in medieval Sentences commentaries", query: 'select ?ref ?reftitle  (count(?element) as ?count) where { ?element a <http://scta.info/resource/nameElement> . ?element <http://scta.info/property/isInstanceOf> ?ref . ?ref <http://purl.org/dc/elements/1.1/title> ?reftitle . ?ref <http://scta.info/property/personType> <http://scta.info/resource/persontype/Biblical> .} group by ?ref ?reftitle'},
	{id: 3, title: "Frequency of Mentions of Classical Names", description: "A Graph that shows the frequency of mentions of Classical authors in medieval Sentences commentaries", query: 'select ?ref ?reftitle  (count(?element) as ?count) where { ?element a <http://scta.info/resource/nameElement> . ?element <http://scta.info/property/isInstanceOf> ?ref . ?ref <http://purl.org/dc/elements/1.1/title> ?reftitle . ?ref <http://scta.info/property/personType> <http://scta.info/resource/persontype/Classical> .} group by ?ref ?reftitle'},
	{id: 4, title: "Frequency of Mentions of Patristic Names", description: "A Graph that shows the frequency of mentions of Patristic authors in medieval Sentences commentaries", query: 'select ?ref ?reftitle  (count(?element) as ?count) where { ?element a <http://scta.info/resource/nameElement> . ?element <http://scta.info/property/isInstanceOf> ?ref . ?ref <http://purl.org/dc/elements/1.1/title> ?reftitle . ?ref <http://scta.info/property/personType> <http://scta.info/resource/persontype/Patristic> .} group by ?ref ?reftitle'},
